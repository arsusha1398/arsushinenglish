...
INSERT INTO public.site_content (key, value) VALUES
  ...
  ('teacher_bio', 'Частный преподаватель английского. 8 лет практики, более 120 учеников, уровни от A1 до C1. Занятия строю вокруг твоей цели: работа, переезд, экзамен или просто свободно говорить.'),
